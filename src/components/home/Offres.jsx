      ...
      <div className="container">
        <div className="pack-card" id="all_packs">
          <div className="culture pack">
            ...
            <div className="pack-description">
              <p>
                ...
                accompagnée d’un guide officiel, vous fera découvrir certains
                secrets de l’ancienne Mogador, si chère aux principales cultures
                artistiques et religieuses. Son classNameement au patrimoine
                mondial de l’UNESCO n’est pas le fruit du hasard...
                <br />
          ...
          <div className="bien-etre pack">
            ...
            <div className="pack-description">
              <p>
                Laissez vous aller à gouter le plaisir du hammam, des massages
                berbères, des soins du corps & visage dans une ambiance aux
                senteurs de fleurs d’orangers, d’eau de rose et d’huile d’argan…
                <br />
                <span className="link_pack">
                  <a href="./">Plus d'infos</a>
                </span>
          ...
          <div className="decouverte pack">
            ...
            <div className="pack-description">
              <p>
                Que ce soit au Golf, sur la plage ou dans la forêt, sur un quad,
                un cheval, un dromadaire, une planche de surf ou de kite surf,
                vous découvrirez de façon ludique et sportive l’authenticité des
                paysages de notre si chère Essaouira…
                <br />
                <span className="link_pack">
                  <a href="./">Plus d'infos</a>
                </span>
          ...
          <div className="gastronomie pack">
            ...
            <div className="pack-description">
              <p>
                ...
                romantiques où vous découvrirez les valeurs traditionnelles de
                la cuisine Marocaine, et notre équipe en cuisine vous guidera,
                si vous le souhaitez, pour la préparation d’un plat que vous
                aurez choisi après une visite des marchés Souiris.
                <br />
                <span className="link_pack">
                  <a href="./">Plus d'infos</a>
                </span>
